...
<%if (locals.panier) { %>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 p-0 panel-liste-articles">
                <% Object.keys(panier.articles).forEach(function(key){ %>

                    <div data-article-id="<%=panier.articles[key].id%>"data-article-prix="<%= panier.articles[key].prix %>" data-article-image="<%= panier.articles[key].image %>" data-article-nom="<%= panier.articles[key].nom %>" class="row bg-white m-2 p-3 border-bottom border-secondary ligne-panier-panel align-items-center">
                        ...
                        <div class="col-6 col-sm-1 button-delete text-right">
                            <button aria-label="Enlever du panier" data-article-id="<%=panier.articles[key].id %>" class="delete-article-in-panier fa fa-trash text-danger bg-transparent border-0"></button>
                        </div>
            ...
            <div class="col-md-12 display-prix-modal">
